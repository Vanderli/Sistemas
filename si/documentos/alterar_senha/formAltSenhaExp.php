		...
		if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "Form")) {
			...
			if($senha_atual == md5($_POST['senha_atual'])){
				...
				if($senha_atual == md5($_POST['nova_senha'])){
					...
					header("Location: formAltSenhaExp.php?action=pwd_equal"); // local para onde estou redirecionando	
				}else{						
				...
				sleep(0);                       						// tempo para redirecionar
				header("Location: formAltSenhaExp.php?action=notEqual"); // local para onde estou redirecionando		
			}
...
<body onLoad="vertical();horizontal();">
	<center><img src="../imagens/topos/topo_sadti.jpg"></center>
	<br />
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="Form" id="Form">
            <fieldset style="width: 500px;">
                ...
                <p align="center">
                    ...
                    <input type="button" onClick="window.location.href='http://<?=$_SERVER['SERVER_NAME'];?>/sigd_sadti/documentos/login/login.php?action=finish'" class="botao" value="Sair" />
                </p>
          </fieldset>
