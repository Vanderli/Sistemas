<?  # conexao com banco de dados
    ...
    $url = "http://".$_SERVER['SERVER_NAME']."/pi";
    $ano = date(Y);
    ...
    $canal->addChild('title', 'PF');
    $canal->addChild('descriion', 'Últimas noticias da PF');
    $canal->addChild('link', $url);
    $canal->addChild('copyright', "Copyright $ano PF - Todos os direitos reservados");
    $canal->addChild('language','-br');
    ...
    while ($dados = mysql_fetch_assoc($query)) {
        ...
        $item->addChild('descriion', $not_comentario);
