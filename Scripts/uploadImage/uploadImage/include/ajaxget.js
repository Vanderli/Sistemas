...
*******/
    ...
    if(ajax1){
        ...
        if(exibe_carregando){ put('Carregando ... <img src="images/carregando.gif" border="0"/>')    }
        ajax1.send(null)
        return true;
    }else{
        return false;
    ...
    function ajaxOnReady(){
        if (ajax1.readyState==4){
            ...
            ajax1 = null
                ...
                put('Carregando ... <img src="images/carregando.gif" border="0"/>')
        }
    }
    function put(valor){ //coloca o valor na variavel/elemento de retorno
        if((typeof(elemento_retorno)).toLowerCase()=="string"){ //se for o nome da string
            ...
            elemento_retorno.innerHTML = valor;  // Alterado aqui
